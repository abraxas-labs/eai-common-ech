...
[XmlRoot(ElementName = "personRoot", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0011/3")]
public class PersonRoot : FieldValueChecker<PersonRoot>
{
    ...
    [FieldRequired]
    [JsonProperty("reportetPerson")]
    [XmlElement(ElementName = "reportetPerson")]
