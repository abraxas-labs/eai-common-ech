...
[Serializable]
[JsonObject("swiss")]
[XmlRoot(ElementName = "swiss", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0011/3")]
public class ForeignerType : FieldValueChecker<ForeignerType>
{
    ...
    public static ForeignerType Create(ResidencePermit residencePermit, DateTime residencePermitTill, string nameOnPassport)
    {
