...
[XmlRoot(ElementName = "countryShort", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0008/3")]
public class CountryShort : FieldValueChecker<CountryShort>
{
    ...
    public CountryShort()
    {
        Xmlns.Add("eCH-0008", "http://www.ech.ch/xmlns/eCH-0008/3");
    }
