...
[Serializable]
[JsonObject("srdmCodeType")]
[XmlRoot(ElementName = "srdmCodeType", IsNullable = true, Namespace = "http://xmlns.vrsg.ch/xmlns/eEK-0020/1")]
public class SrdmCodeType : FieldValueChecker<SrdmCodeType>
{
