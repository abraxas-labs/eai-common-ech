...
[XmlRoot(ElementName = "municipalityRoot", IsNullable = false, Namespace = "http://www.ech.ch/xmlns/eCH-0007/5")]
public class MunicipalityRoot
{
    ...
    {
        Xmlns.Add("eCH-0007", "http://www.ech.ch/xmlns/eCH-0007/5");
    }
    ...
    [XmlElement(ElementName = "swissMunicipality", Order = 1)]
    public SwissMunicipality SwissMunicipality { get; set; }

    [JsonProperty("swissAndFlMunicipality")]
    [XmlElement(ElementName = "swissAndFlMunicipality", Order = 2)]
