...
[XmlRoot(ElementName = "addressInformation", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0010-f/5")]
public class AddressInformation : FieldValueChecker<AddressInformation>
{
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool ForeignZipCodeSpecified => ForeignZipCode != null;
