...
public class BusinessInformation
{
    ...
    private const string BusinessCommentValidateExceptionMessage = "businessComment is not valid! businessComment cannot be null and the length must be less or equal than 512 characters";
