...
[XmlRoot(ElementName = "reportingMunicipalityRestrictedMoveIn", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class ReportingMunicipalityRestrictedMoveIn
{
    ...
    public static ReportingMunicipalityRestrictedMoveIn Create(SwissMunicipality reportingMunicipality, DateTime arrivalDate, DwellingAddress dwellingAddress, Destination comesFrom)
    {
    ...
    /// <param name="dwellingAddress">Field id required.</param>
    /// <returns>ReportingMunicipalityType.</returns>
    public static ReportingMunicipalityRestrictedMoveIn Create(FederalRegisterType? federalRegister, DateTime arrivalDate, DwellingAddress dwellingAddress, Destination comesFrom)
    {
