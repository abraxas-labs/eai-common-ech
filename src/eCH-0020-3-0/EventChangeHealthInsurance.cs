...
[XmlRoot(ElementName = "eventChangeHealthInsurance", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventChangeHealthInsurance
{
    ...
    private const string ChangeHealthInsurancePersonNullValidateExceptionMessage = "ChangeHealthInsurancePerson is not valid! ChangeHealthInsurancePerson is required";
    ...
    public PersonIdentification ChangeHealthInsurancePerson
    {
        ...
        set
        {
            _changeHealthInsurancePerson = value ?? throw new XmlSchemaValidationException(ChangeHealthInsurancePersonNullValidateExceptionMessage);
        }
    }
