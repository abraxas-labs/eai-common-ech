...
[XmlRoot(ElementName = "eventChangeFireService", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventChangeFireService
{
    ...
    private const string ChangeFireServicePersonNullValidateExceptionMessage = "ChangeFireServicePerson is not valid! ChangeFireServicePerson is required";
    ...
    public PersonIdentification ChangeFireServicePerson
    {
        ...
        set
        {
            _changeFireServicePerson = value ?? throw new XmlSchemaValidationException(ChangeFireServicePersonNullValidateExceptionMessage);
        }
    }
