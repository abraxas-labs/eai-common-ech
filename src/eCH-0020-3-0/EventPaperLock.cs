...
[XmlRoot(ElementName = "eventPaperLock", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventPaperLock
{
    ...
    private const string PaperLockPersonNullValidateExceptionMessage = "PaperLockPerson is not valid! PaperLockPerson is required";
    ...
    public PersonIdentification PaperLockPerson
    {
        ...
        set
        {
            _paperLockPerson = value ?? throw new XmlSchemaValidationException(PaperLockPersonNullValidateExceptionMessage);
        }
    }
