...
[XmlRoot(ElementName = "eventCorrectGuardianRelationship", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventCorrectGuardianRelationship
{
    ...
    private const string CorrectGuardianRelationshipPersonNullValidateExceptionMessage = "CorrectGuardianRelationshipPerson is not valid! CorrectGuardianRelationshipPerson is required";
    ...
    public PersonIdentification CorrectGuardianRelationshipPerson
    {
        ...
        set
        {
            _correctGuardianRelationshipPerson = value ?? throw new XmlSchemaValidationException(CorrectGuardianRelationshipPersonNullValidateExceptionMessage);
        }
    }
