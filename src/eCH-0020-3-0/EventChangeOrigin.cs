...
public class EventChangeOrigin
{
    ...
    private const string ChangeOriginPersonNullValidateExceptionMessage = "ChangeOriginPerson is not valid! ChangeOriginPerson is required";
    ...
    public PersonIdentification ChangeOriginPerson
    {
        ...
        set
        {
            _changeOriginPerson = value ?? throw new XmlSchemaValidationException(ChangeOriginPersonNullValidateExceptionMessage);
        }
    }
