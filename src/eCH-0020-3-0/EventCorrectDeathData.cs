...
[XmlRoot(ElementName = "eventCorrectDeathData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventCorrectDeathData
{
    ...
    private const string CorrectDeathDataPersonNullValidateExceptionMessage = "CorrectDeathDataPerson is not valid! CorrectDeathDataPerson is required";
    ...
    public PersonIdentification CorrectDeathDataPerson
    {
        ...
        set
        {
            _correctDeathDataPerson = value ?? throw new XmlSchemaValidationException(CorrectDeathDataPersonNullValidateExceptionMessage);
        }
    }
