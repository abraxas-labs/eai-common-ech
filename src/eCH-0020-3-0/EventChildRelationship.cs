...
[Serializable]
[JsonObject("delivery")]
[XmlRoot(ElementName = "eventChildRelationship", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventChildRelationship
{
    ...
    private const string ChildRelationshipPersonNullValidateExceptionMessage = "ChildRelationshipPerson is not valid! AdoptionPerson is required";
    ...
    public PersonIdentification ChildRelationshipPerson
    {
        ...
        set
        {
            _childRelationshipPerson = value ?? throw new XmlSchemaValidationException(ChildRelationshipPersonNullValidateExceptionMessage);
        }
    }
