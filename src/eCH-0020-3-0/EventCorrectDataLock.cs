...
[XmlRoot(ElementName = "eventCorrectDataLock", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventCorrectDataLock
{
    ...
    private const string CorrectDataLockPersonNullValidateExceptionMessage = "CorrectDataLockPerson is not valid! CorrectDataLockPerson is required";
    ...
    public PersonIdentification CorrectDataLockPerson
    {
        ...
        set
        {
            _correctDataLockPerson = value ?? throw new XmlSchemaValidationException(CorrectDataLockPersonNullValidateExceptionMessage);
        }
    }
