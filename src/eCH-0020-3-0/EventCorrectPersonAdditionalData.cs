...
[XmlRoot(ElementName = "eventCorrectPersonAdditionalData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventCorrectPersonAdditionalData
{
    ...
    private const string CorrectPersonAdditionalDataPersonNullValidateExceptionMessage = "CorrectPersonAdditionalDataPerson is not valid! CorrectPersonAdditionalDataPerson is required";
    ...
    public PersonIdentification CorrectPersonAdditionalDataPerson
    {
        ...
        set
        {
            _correctPersonAdditionalDataPerson = value ?? throw new XmlSchemaValidationException(CorrectPersonAdditionalDataPersonNullValidateExceptionMessage);
        }
    }
