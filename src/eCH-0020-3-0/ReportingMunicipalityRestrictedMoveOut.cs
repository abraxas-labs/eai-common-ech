...
[XmlRoot(ElementName = "reportingMunicipalityRestrictedMoveOut", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class ReportingMunicipalityRestrictedMoveOut
{
    ...
    private const string GoesToNullValidateExceptionMessage = "GoesTo is not valid! GoesTo is required";
    ...
    public Destination GoesTo
    {
        ...
        set
        {
            _goesTo = value ?? throw new XmlSchemaValidationException(GoesToNullValidateExceptionMessage);
        }
    }
}
