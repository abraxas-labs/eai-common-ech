...
[XmlRoot(ElementName = "eventGuardianMeasure", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventGuardianMeasure
{
    ...
    private const string GuardianMeasurePersonNullValidateExceptionMessage = "GuardianMeasurePerson is not valid! GuardianMeasurePerson is required";
    ...
    public PersonIdentification GuardianMeasurePerson
    {
        ...
        set
        {
            _guardianMeasurePerson = value ?? throw new XmlSchemaValidationException(GuardianMeasurePersonNullValidateExceptionMessage);
        }
    }
