...
[XmlRoot(ElementName = "eventCare", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventCare
{
    ...
    private const string CarePersonNullValidateExceptionMessage = "CarePerson is not valid! CarePerson is required";
    ...
    public PersonIdentification CarePerson
    {
        ...
        set
        {
            _carePerson = value ?? throw new XmlSchemaValidationException(CarePersonNullValidateExceptionMessage);
        }
    }
