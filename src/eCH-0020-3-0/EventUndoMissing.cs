...
[XmlRoot(ElementName = "eventUndoMissing", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventUndoMissing
{
    ...
    private const string UndoMissingPersonNullValidateExceptionMessage = "UndoMissingPerson is not valid! UndoMissingPerson is required";
    ...
    public PersonIdentification UndoMissingPerson
    {
        ...
        set
        {
            _undoMissingPerson = value ?? throw new XmlSchemaValidationException(UndoMissingPersonNullValidateExceptionMessage);
        }
    }
