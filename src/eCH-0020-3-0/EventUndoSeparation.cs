...
[XmlRoot(ElementName = "eventUndoSeparation", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventUndoSeparation
{
    ...
    private const string UndoSeparationPersonNullValidateExceptionMessage = "UndoSeparationPerson is not valid! UndoSeparationPerson is required";
    ...
    public PersonIdentification UndoSeparationPerson
    {
        ...
        set
        {
            _undoSeparationPerson = value ?? throw new XmlSchemaValidationException(UndoSeparationPersonNullValidateExceptionMessage);
        }
    }
