...
[XmlRoot(ElementName = "eventChangeSex", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventChangeSex
{
    ...
    private const string ChangeSexPersonNullValidateExceptionMessage = "ChangeSexPerson is not valid! ChangeSexPerson is required";
    ...
    public ChangeSexPerson ChangeSexPerson
    {
        ...
        set
        {
            _changeSexPerson = value ?? throw new XmlSchemaValidationException(ChangeSexPersonNullValidateExceptionMessage);
        }
    }
