...
[XmlRoot(ElementName = "eventChangeCivilDefense", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventChangeCivilDefense
{
    ...
    private const string ChangeCivilDefensePersonNullValidateExceptionMessage = "ChangeCivilDefensePerson is not valid! ChangeCivilDefensePerson is required";
    ...
    public PersonIdentification ChangeCivilDefensePerson
    {
        ...
        set
        {
            _changeCivilDefensePerson = value ?? throw new XmlSchemaValidationException(ChangeCivilDefensePersonNullValidateExceptionMessage);
        }
    }
