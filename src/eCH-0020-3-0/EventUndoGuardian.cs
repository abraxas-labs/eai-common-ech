...
[XmlRoot(ElementName = "eventUndoGuardian", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020/3")]
public class EventUndoGuardian
{
    ...
    private const string UndoGuardianPersonNullValidateExceptionMessage = "UndoGuardianPerson is not valid! UndoGuardianPerson is required";
    ...
    public PersonIdentification UndoGuardianPerson
    {
        ...
        set
        {
            _undoGuardianPerson = value ?? throw new XmlSchemaValidationException(UndoGuardianPersonNullValidateExceptionMessage);
        }
    }
