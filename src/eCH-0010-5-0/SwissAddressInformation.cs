...
[XmlRoot(ElementName = "swissAddressInformation", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0010/5")]
public class SwissAddressInformation : FieldValueChecker<SwissAddressInformation>
{
    ...
    /// <returns>SwissAddressInformation.</returns>
    public static SwissAddressInformation Create(string town, int swissZipCode, string country)
        => new()
        {
            AddressLine1 = null,
            AddressLine2 = null,
