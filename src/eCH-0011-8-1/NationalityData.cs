...
[XmlRoot(ElementName = "nationalityData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0011/8")]
public class NationalityData
{
    ...
    /// <returns></returns>
    public static NationalityData Create(NationalityStatus nationalityStatus, List<CountryInfo> countryInfos = null)
    {
    ...
    [XmlElement(ElementName = "nationalityStatus", Order = 1)]
    public NationalityStatus NationalityStatus { get; set; }

    [JsonProperty("countryInfo")]
    [XmlElement(ElementName = "countryInfo", Order = 2)]
