...
[XmlRoot(ElementName = "swissAndFlMunicipality", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0007-f/5")]
public class SwissAndFlMunicipality : FieldValueChecker<SwissAndFlMunicipality>
{
    ...
    {
        Xmlns.Add("eCH-0007", "http://www.ech.ch/xmlns/eCH-0007-f/5");
    }
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool CantonFlAbbreviationSpecified => CantonFlAbbreviation.HasValue;
