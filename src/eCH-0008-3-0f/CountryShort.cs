...
[XmlRoot(ElementName = "countryShort", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0008-f/3")]
public class CountryShort : FieldValueChecker<CountryShort>
{
    ...
    public CountryShort()
    {
        Xmlns.Add("eCH-0008", "http://www.ech.ch/xmlns/eCH-0008-f/3");
    }
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool CountryNameShortSpecified => !string.IsNullOrWhiteSpace(CountryNameShort);
}
