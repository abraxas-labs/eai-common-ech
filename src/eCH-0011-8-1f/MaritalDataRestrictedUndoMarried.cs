...
/// </summary>
[Serializable]
[JsonObject("maritalDataRestrictedUndoMarried")]
[XmlRoot(ElementName = "maritalDataRestrictedUndoMarried", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0011-f/8")]
public class MaritalDataRestrictedUndoMarried
{
    [JsonIgnore]
    [XmlNamespaceDeclarations]
    public XmlSerializerNamespaces Xmlns = new();

    public MaritalDataRestrictedUndoMarried()
    {
    ...
    public static MaritalDataRestrictedUndoMarried Create(MaritalStatus maritalStatus, DateTime dateOfMaritalStatus)
    {
        return new MaritalDataRestrictedUndoMarried()
        {
