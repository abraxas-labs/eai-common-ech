...
[XmlRoot(ElementName = "foreigner", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/1")]
public class Foreigner
{
    ...
    private SwissAddressInformation _dwellingAddress;
    ...
    public SwissAddressInformation DwellingAddress
    {
    ...
    [XmlElement(ElementName = "inCantonSince", DataType = "date")]
    ...
    public static Foreigner Create(ResidencePermit residencePermit, SwissAddressInformation dwellingAddress,
        DateTime inCantonSince, Country nationality)
    {
    ...
    /// <param name="inCantonSince">Field is optional.</param>
    /// <returns>Foreigner.</returns>
    public static Foreigner Create(SwissAddressInformation dwellingAddress, DateTime inCantonSince)
    {
        return new Foreigner
        {
            DwellingAddress = dwellingAddress,
