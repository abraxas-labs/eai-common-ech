...
[Serializable]
[JsonObject("list")]
[XmlRoot(ElementName = "list", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/1")]
public class List
{
    ...
    [JsonProperty("listIdentifiaction")]
    [XmlElement(ElementName = "listIdentifiaction")]
