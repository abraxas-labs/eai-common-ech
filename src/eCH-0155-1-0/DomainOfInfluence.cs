...
[XmlRoot(ElementName = "domainOfInfluence", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/1")]
public class DomainOfInfluence
{
    ...
    [XmlElement(ElementName = "domainOfInfluenceType")]
    ...
    [JsonProperty("localDomainOfInfluencetId")]
    [XmlElement(ElementName = "localDomainOfInfluencetId")]
    public string LocalDomainOfInfluencetId
    {
        ...
        string localDomainOfInfluenceId, string domainOfIfnluenceName, string domainOfInfluenceShortName)
    {
        return new DomainOfInfluence
        {
            ...
            LocalDomainOfInfluencetId = localDomainOfInfluenceId,
