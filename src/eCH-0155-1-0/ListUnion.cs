...
[XmlRoot(ElementName = "listUnion", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/1")]
public class ListUnion
{
    ...
    private List<string> _referencedList;
    ...
    public List<string> ReferencedList
    {
        get => _referencedList;
        set
        {
