...
[XmlRoot(ElementName = "swissAddressInformation", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0010/4")]
public class SwissAddressInformation : FieldValueChecker<SwissAddressInformation>
{
    ...
    {
        Xmlns.Add("eCH-0010", "http://www.ech.ch/xmlns/eCH-0010/4");
    }
    ...
    public string Country
    {
        ...
        set
        {
            CheckAndSetValue(ref _country, value);
            if (value != "CH")
            {
                throw new FieldValidationException("Country is not valid! Country must be constant CH");
            }
        }
    }
}
