...
[XmlRoot(ElementName = "addressInformation", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0010/4")]
public class AddressInformation : FieldValueChecker<AddressInformation>
{
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool ForeignZipCodeSpecified => !string.IsNullOrEmpty(ForeignZipCode);
