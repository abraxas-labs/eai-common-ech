...
[XmlRoot(ElementName = "mailAddress", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0010/4")]
public class MailAddress : FieldValueChecker<MailAddress>
{
    ...
    /// <param name="addressInformation">Field is reqired.</param>
    /// <returns>PersonMailAddress.</returns>
    public static MailAddress Create(PersonMailAddressInfo personMailAddressInfo,
        AddressInformation addressInformation)
    {
