...
[XmlRoot(ElementName = "organisation", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0010/4")]
public class OrganisationMailAddressInfo : FieldValueChecker<OrganisationMailAddressInfo>
{
    ...
    {
        get { return _organisationNameAddOn1; }
    ...
    {
        get { return _organisationNameAddOn2; }
