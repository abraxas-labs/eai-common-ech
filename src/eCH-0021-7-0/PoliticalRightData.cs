...
[XmlRoot(ElementName = "politicalRightData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021/7")]
public class PoliticalRightData
{
    ...
    [XmlElement(ElementName = "restrictedVotingAndElectionRightFederation", Order = 1)]
