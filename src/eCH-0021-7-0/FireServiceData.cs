...
[XmlRoot(ElementName = "fireServiceData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021/7")]
public class FireServiceData
{
    ...
    [XmlElement(ElementName = "fireService", Order = 1)]
    ...
    [XmlElement(ElementName = "fireServiceLiability", Order = 2)]
    ...
    [XmlElement(DataType = "date", ElementName = "fireServiceValidFrom", Order = 3)]
