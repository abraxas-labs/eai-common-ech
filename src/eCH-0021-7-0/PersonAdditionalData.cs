...
[XmlRoot(ElementName = "personAdditional", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021/7")]
public class PersonAdditionalData
{
    ...
    [XmlElement(ElementName = "languageOfCorrespondance", Order = 3)]
