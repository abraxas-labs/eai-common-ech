...
[XmlRoot(ElementName = "placeOfOriginAddonRestrictedUnDoData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021/7")]
public class PlaceOfOriginAddonRestrictedUnDoData
{
    ...
    [XmlElement(DataType = "date", ElementName = "expatriationDate", Order = 1)]
