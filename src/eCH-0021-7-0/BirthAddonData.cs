...
[XmlRoot(ElementName = "birthAddonData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021/7")]
public class BirthAddonData
{
    ...
    [XmlElement(ElementName = "nameOfFather", Order = 1)]
    ...
    [XmlElement(ElementName = "nameOfMother", Order = 2)]
