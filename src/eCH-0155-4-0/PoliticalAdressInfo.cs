...
[XmlRoot(ElementName = "politicalAdressInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class PoliticalAdressInfo
{
    ...
    [XmlElement(ElementName = "swissAddressInformation", Order = 1)]
    ...
    [XmlElement(ElementName = "municipalityId", Order = 2)]
