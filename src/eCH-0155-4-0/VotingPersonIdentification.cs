...
[XmlRoot(ElementName = "votingPersonIdentification", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class VotingPersonIdentification
{
    ...
    [XmlElement(ElementName = "officialName", Order = 4)]
    ...
    [XmlElement(ElementName = "firstName", Order = 5)]
    ...
    [XmlElement(ElementName = "dateOfBirth", Order = 7)]
        ...
        string officialName, string firstName, SexType sex, DatePartiallyKnown dateOfBirth)
    {
        return new VotingPersonIdentification
        {
            ...
            OtherPersonId = (otherPersonId != null) ? otherPersonId.ToArray() : null,
