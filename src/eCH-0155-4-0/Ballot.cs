...
[Serializable]
[JsonObject("ballot")]
[XmlRoot(ElementName = "String", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class Ballot
{
    ...
    [XmlElement(ElementName = "ballotPosition", Order = 2)]
    ...
    [XmlElement(ElementName = "ballotDescription", Order = 3)]
    ...
    [XmlElement(ElementName = "ballotGroup", Order = 4)]
    ...
    [XmlElement("standardBallot", typeof(StandardBallotType), Order = 5)]
    [XmlElement("variantBallot", typeof(VariantBallot), Order = 5)]
    ...
    public object BallotTypeChoice
    {
        ...
        set
        {
            ...
            if (value is StandardBallotType)
            {
