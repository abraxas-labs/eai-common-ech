...
[XmlRoot(ElementName = "tieBreakQuestion", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class TieBreakQuestion
{
    ...
    public List<TieBreakQuestionInfo> TieBreakQuestionInfo
    {
        ...
        set
        {
            _tieBreakQuestionInfo = value ?? throw new XmlSchemaValidationException(TieBreakQuestionNullValidateExceptionMessage);
        }
    }
