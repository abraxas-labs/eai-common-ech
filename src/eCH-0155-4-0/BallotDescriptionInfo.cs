...
[XmlRoot(ElementName = "ballotDescriptionInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class BallotDescriptionInfo : FieldValueChecker<BallotDescriptionInfo>
{
    ...
    [XmlElement(ElementName = "ballotDescriptionLong", Order = 2)]
    ...
    [XmlElement(ElementName = "ballotDescriptionShort", Order = 3)]
    ...
    public static BallotDescriptionInfo Create(string language, string ballotDescriptionLong,
    ...
    /// <param name="language">Field is required.</param>
    /// <returns>BallotDescriptionInfo.</returns>
    public static BallotDescriptionInfo Create(string language)
    {
        return new BallotDescriptionInfo
        {
            Language = language
