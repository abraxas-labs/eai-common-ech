...
[XmlRoot(ElementName = "partyAffiliationInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class PartyAffiliationInfo : FieldValueChecker<PartyAffiliationInfo>
{
    ...
    [XmlElement(ElementName = "partyAffiliation", Order = 2)]
    ...
    [XmlElement(ElementName = "partyAffiliationShort", Order = 3)]
    ...
    public static PartyAffiliationInfo Create(string language, string partyAffiliationShort)
    {
