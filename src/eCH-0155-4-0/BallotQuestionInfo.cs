...
[XmlRoot(ElementName = "ballotQuestionInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class BallotQuestionInfo : FieldValueChecker<BallotQuestionInfo>
{
    ...
    [XmlElement(ElementName = "ballotQuestionTitle", Order = 2)]
    ...
    [XmlElement(ElementName = "ballotQuestion", Order = 3)]
    ...
    public static BallotQuestionInfo Create(string language, string ballotQuestionTitle, string ballotQuestion)
    {
    ...
    /// <returns>BallotQuestionInfo.</returns>
    public static BallotQuestionInfo Create(string language, string ballotQustion)
    {
        return new BallotQuestionInfo
        {
            Language = language,
