...
[XmlRoot(ElementName = "occupationalTitleInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class OccupationalTitleInfo : FieldValueChecker<OccupationalTitleInfo>
{
    ...
    [XmlElement(ElementName = "occupationalTitle", Order = 2)]
    ...
    public static OccupationalTitleInfo Create(string language, string occupationalTitle)
    {
