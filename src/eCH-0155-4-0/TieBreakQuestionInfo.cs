...
[XmlRoot(ElementName = "tieBreakQuestionInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/4")]
public class TieBreakQuestionInfo : FieldValueChecker<TieBreakQuestionInfo>
{
    ...
    [XmlElement(ElementName = "tieBreakQuestionTitle", Order = 2)]
    ...
    [XmlElement(ElementName = "tieBreakQuestion", Order = 3)]
    ...
    [XmlElement(ElementName = "tieBreakQuestion2", Order = 4)]
    ...
    public static TieBreakQuestionInfo Create(string language, string tieBreakQuestionTitle,
    ...
    /// <returns>TieBreakQuestionInfo.</returns>
    public static TieBreakQuestionInfo Create(string language, string tieBreakQustion)
    {
        return new TieBreakQuestionInfo
        {
            Language = language,
