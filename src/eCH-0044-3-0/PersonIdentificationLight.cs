...
[XmlRoot(ElementName = "personIdentification", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0044/3")]
public class PersonIdentificationLight : FieldValueChecker<PersonIdentificationLight>
{
    ...
    public static PersonIdentificationLight Create(ulong? vn, NamedPersonId localPersonId, List<NamedPersonId> otherPersonIds, string officialName, string firstName, SexType? sex, DatePartiallyKnown dateOfBirt)
    {
