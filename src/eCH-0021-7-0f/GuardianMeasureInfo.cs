...
[XmlRoot(ElementName = "guardianMeasureInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021-f/7")]
public class GuardianMeasureInfo
{
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool BasedOnLawAddOnSpecified => !string.IsNullOrWhiteSpace(BasedOnLawAddOn);

    [JsonProperty("guardianMeasureValidFrom")]
    [XmlElement(DataType = "date", ElementName = "guardianMeasureValidFrom")]
    public DateTime? GuardianMeasureValidFrom { get; set; }

    [JsonIgnore]
    [XmlIgnore]
    public bool GuardianMeasureValidFromSpecified => GuardianMeasureValidFrom.HasValue;
}
