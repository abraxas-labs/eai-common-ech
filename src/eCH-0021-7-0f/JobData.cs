...
[Serializable]
[JsonObject("jobData")]
[XmlRoot(ElementName = "jobData", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021-f/7")]
public class JobData
{
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool KindOfEmploymentSpecified => !string.IsNullOrWhiteSpace(KindOfEmployment);
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool JobTitleSpecified => !string.IsNullOrWhiteSpace(JobTitle);

    [JsonProperty("occupationData")]
    [XmlElement(ElementName = "occupationData")]
