...
[XmlRoot(ElementName = "uidStructure", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0021-f/7")]
public class UidStructure
{
    ...
    [XmlElement(ElementName = "uidOrganisationIdCategorie")]
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool UidOrganisationIdCategorieSpecified => !string.IsNullOrWhiteSpace(UidOrganisationIdCategorie);

    [JsonProperty("uidOrganisationId")]
    [XmlElement(ElementName = "uidOrganisationId")]
    public int? UidOrganisationId
    {
        ...
        set
        {
            if (UidOrganisationId.HasValue && value < 1 && value > 999999999)
            {
    ...
    [JsonIgnore]
    [XmlIgnore]
    public bool UidOrganisationIdSpecified => UidOrganisationId.HasValue;
}
