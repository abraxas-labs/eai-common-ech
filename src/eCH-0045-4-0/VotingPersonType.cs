...
[XmlRoot(ElementName = "votingPersonType", IsNullable = false, Namespace = "http://www.ech.ch/xmlns/eCH-0045/4")]
public class VotingPersonType : FieldValueChecker<VotingPersonType>
{
    [JsonIgnore]
    ...
    /// <returns>VotingPersonType.</returns>
    public static VotingPersonType Create(Nationality person, DataLockType dataLock, PersonMailAddressType electoralAddress, List<DomainOfInfluenceInfoType> domainOfInfluenceInfo)
    {
        return new VotingPersonType
        {
            ...
            DomainOfInfluenceInfo = domainOfInfluenceInfo
        };
    }
    ...
    /// <param name="domainOfInfluenceInfo">Field is required.</param>
    /// <returns>VotingPersonType.</returns>
    public static VotingPersonType Create(Nationality person, DataLockType dataLock, PersonMailAddressType electoralAddress,
        PersonMailAddressType deliveryAddress, EmailType email, PhoneType phone, bool? isEvoter, List<DomainOfInfluenceInfoType> domainOfInfluenceInfo)
    {
        return new VotingPersonType
        {
            Person = person,
    ...
    [XmlIgnore]
    [JsonIgnore]
    public bool IsEvoterSpecified => IsEvoter.HasValue;

    [FieldRequired]
    [JsonProperty("domainOfInfluenceInfo")]
    [XmlElement(ElementName = "domainOfInfluenceInfo", Order = 8)]
    public List<DomainOfInfluenceInfoType> DomainOfInfluenceInfo { get; set; }
}
