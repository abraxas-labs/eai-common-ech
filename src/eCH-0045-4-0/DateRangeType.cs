...
[XmlRoot(ElementName = "dateRangeType", IsNullable = false, Namespace = "http://www.ech.ch/xmlns/eCH-0045/4")]
public class DateRangeType : FieldValueChecker<DateRangeType>
{
    ...
    /// <returns>DateRangeType.</returns>
    public static DateRangeType Create(DateTime? dateFrom, DateTime? dateTo)
    {
    ...
    [XmlElement(DataType = "date", ElementName = "dateFrom", Order = 1)]
    ...
    [JsonProperty("dateTo")]
    [XmlElement(DataType = "date", ElementName = "dateTo", Order = 2)]
