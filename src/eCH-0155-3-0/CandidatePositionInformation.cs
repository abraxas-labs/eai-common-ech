...
[XmlRoot(ElementName = "candidatePositionInformation", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/3")]
public class CandidatePositionInformation
{
    ...
    [XmlElement(ElementName = "candidateIdentification")]
