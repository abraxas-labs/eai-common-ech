...
[XmlRoot(ElementName = "candidate", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0155/3")]
public class Candidate
{
    ...
    private const string CandidateReferenceOutOfRangeValidateExceptionMessage =
        "CandidateReference is not valid! CandidateReference has minimal leght of 1 and has maximal length of 10";
    ...
    public static Candidate Create(string vn, string candidateIdentification, string familyName, string firstName,
        ...
        MrMrsType? mrMrs, Language? languageOfCorrespondence, bool? incumbentYesNo, RoleInformation role,
