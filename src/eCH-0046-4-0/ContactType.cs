...
[XmlRoot(ElementName = "contactType", IsNullable = false, Namespace = "http://www.ech.ch/xmlns/eCH-0046/4")]
public class ContactType : FieldValueChecker<ContactType>
{
    ...
    /// </summary>
    /// <param name="localId">Field is optional.</param>
    ...
    public static ContactType Create(NamedPersonId localId = null, List<AddressType> address = null, List<EmailType> email = null, List<PhoneType> phone = null, List<InternetType> internet = null)
    {
    ...
    [XmlIgnore]
    [JsonIgnore]
    public bool NamedPersonIdSpecified => LocalId != null;
