...
[Serializable]
[JsonObject("contactRoot")]
[XmlRoot(ElementName = "contactRoot", IsNullable = false, Namespace = "http://www.ech.ch/xmlns/eCH-0046/4")]
public class ContactRoot : FieldValueChecker<ContactRoot>
{
    ...
    /// </summary>
    /// <param name="contact">Field is required.</param>
