...
[XmlRoot(ElementName = "sendingApplication", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0058/5")]
public class SendingApplication
{
    ...
    private const string ManufacturerNullValidateExceptionMessage = "Manufacturer is not valid! Manufacturer is required";
    private const string ManufacturerValidateExceptionMessage = "Manufacturer is not valid! Manufacturer  has max Length of 30";
    ...
    private const string ProductVersionNullValidateExceptionMessage = "ProductVersion is not valid! ProductVersion is required";
    private const string ProductVersionValidateExceptionMessage = "ProductVersion is not valid! ProductVersion  has max Length of 10";
    ...
    [XmlElement(ElementName = "manufacturer", Order = 1)]
    ...
    [XmlElement(ElementName = "product", Order = 2)]
    ...
    [XmlElement(ElementName = "productVersion", Order = 3)]
