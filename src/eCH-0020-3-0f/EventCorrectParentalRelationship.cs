...
[XmlRoot(ElementName = "eventCorrectParentalRelationship", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020-f/3")]
public class EventCorrectParentalRelationship
{
    ...
    public PersonIdentification CorrectParentalRelationshipPerson
    {
        ...
        set { _correctParentalRelationshipPerson = value; }
    }
