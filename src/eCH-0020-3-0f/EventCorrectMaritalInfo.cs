...
[XmlRoot(ElementName = "eventCorrectMaritalInfo", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020-f/3")]
public class EventCorrectMaritalInfo
{
    ...
    public PersonIdentification CorrectMaritalDataPerson
    {
        ...
        set { _correctMaritalDataPerson = value; }
    }
