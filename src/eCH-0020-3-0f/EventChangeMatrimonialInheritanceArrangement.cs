...
[XmlRoot(ElementName = "eventChangeMatrimonialInheritanceArrangement", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020-f/3")]
public class EventChangeMatrimonialInheritanceArrangement
{
    ...
    public PersonIdentification ChangeMatrimonialInheritanceArrangementPerson
    {
        ...
        set { _changeMatrimonialInheritanceArrangementPerson = value; }
    }
