...
[Serializable]
[JsonObject("delivery")]
[XmlRoot(ElementName = "delivery", IsNullable = true, Namespace = "http://www.ech.ch/xmlns/eCH-0020-f/3")]
public class Delivery
{
    ...
    public static Delivery Create(eCH_0020_3_0.Header deliveryHeader, eCH_0020_3_0.EventMoveIn moveIn)
    {
        return new Delivery
        {
            DeliveryHeader = Mapper.ECHtoECHf.GetHeader(deliveryHeader),
            MoveIn = Mapper.ECHtoECHf.GetEventMoveIn(moveIn)
        };
    }
    ...
    public static Delivery Create(eCH_0020_3_0.Header deliveryHeader, eCH_0020_3_0.EventMoveOut moveOut)
    {
        return new Delivery
        {
            DeliveryHeader = Mapper.ECHtoECHf.GetHeader(deliveryHeader),
            MoveOut = Mapper.ECHtoECHf.GetEventMoveOut(moveOut)
        };
    }
