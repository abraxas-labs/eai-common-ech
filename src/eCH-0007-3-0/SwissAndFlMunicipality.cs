...
[XmlRoot(ElementName = "swissAndFlMunicipality", IsNullable = false, Namespace = "http://www.ech.ch/xmlns/eCH-0007/3")]
public class SwissAndFlMunicipality : FieldValueChecker<SwissAndFlMunicipality>
{
    ...
    {
        Xmlns.Add("eCH-0007", "http://www.ech.ch/xmlns/eCH-0007/3");
    }
